...
> - [04 · Données](../../../cours/04-donnees.md) : d3-fetch, CSV/JSON, map, filter, reduce

## Installation

Comme l'exercice précédent, le dossier d'exercice contient les éléments nécéssaires pour démarrer un serveur [Node.js](https://nodejs.org/en/) en local et de _traduire_ votre code ES6 dans un langage lisible par le navigateur avec [Vite](https://vitejs.dev/).
...
- Dessinez un graphique en bâton en ayant sur l'axe _x_ les utilisateurs et _y_ avec la longueur totale de tous les textes écrits par chaque utilisateur (somme des longueurs de tous les posts écrits par chaque utilisateur)
