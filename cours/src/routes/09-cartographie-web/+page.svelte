...
<Slide>
    ...
    <ul>
        <li>
            <code
                ><a
                    href="https://observablehq.com/@idris-maps/donnees-cartographiques"
                    >geojson</a
                ></code
            >
        ...
        <li>
            <code
                ><a href="https://wiki.openstreetmap.org/wiki/OSM_XML"
                    >OSM (xml)</a
                ></code
            > OpenStreetMap
        </li>
        <li>
            <code
                ><a href="https://fr.wikipedia.org/wiki/Shapefile">shp</a
                ></code
            > Shapefile
        </li>
        <li>
        ...
        <li>
            <code><a href="https://geoparquet.org/">GeoParquet</a></code> Extension
            Parquet pour les données géographiques (cloud based)
        </li>
    </ul>
    <Reference
...
<Slide>
    ...
    <div class="row">
        <q class="small col-60">
            ...
            Google. OpenStreetMap is an open data source, and its information
            is available to every organisation and user.
        </q>
    </div>
    <Reference
    ...
    <div class="row">
        <div class="col-80">
            <ul>
                ...
                <li class="small">
                    Par types d'objets : <a
                        href="https://overpass-turbo.osm.ch/"
...
<Slide>
    ...
    <ul>
        ...
        <li>
            Cherchez un mot clef comme <em>pub</em>, <em>bar</em>,
            <em>tree</em> etc.
        </li>
        <li>
...
<Slide>
    ...
    <ul>
        ...
        <li class="small">
            <a href="https://giro3d.org/examples/">Giro3D</a>
        </li>
    </ul>
    <ul></ul>
</Slide>
...
<Slide>
    ...
    <div class="row">
        ...
        <div class="col-70">
            ...
            <small
                ><code
                    >let projection = <span class="dheig-re"
                        ><em>nom_projection</em></span
                    >()</code
                ></small
            ><br /><br />
            <Reference
...
<Slide>
    ...
    <small
        ><code>projection.<span class="red">fonction</span>(arguments)</code
        ></small
    >
    ...
    <div class="row">
        ...
        <div class="col-50">
            ...
            <small
                ><code
                    >.<span class="red">fitSize</span>([width, height],
                    geojson)</code
                > <br />Adapter selon largeur/hauteur du SVG
                <br /><br />

                <code
                    >.<span class="red">fitExtent</span>([X<sub>0</sub>, Y<sub
                        >0</sub
    ...
    <div class="row">
        <div class="col-50">
            ...
            <ol>
                ...
                <small
                    ><li>
                        Dessiner <em><code>path</code></em> selon les données
                    </li></small
                >
            </ol>
        </div>
...
<Slide>
    <a href="https://leafletjs.com/"
        ><h3><code class="red">Leaflet</code></h3></a
    >
    <p>
        <span class="red">Installation</span> <br />
        ...
        <div class="col-50">
            ...
            <ol>
                ...
                <small
                    ><li>
                        Générer un élément <em
                            ><a
                                href="https://leafletjs.com/reference.html#map-example"
                                >map</a
                            ></em
                        >
                    </li></small
                ...
                <small
                    ><li>
                        Écouter des <a
                            href="https://leafletjs.com/reference.html#map-event"
                            >événements</a
                        >
                    </li></small
                >
    ...
    <ul>
        <li>
            Cartes de chaleurs: <a
                href="https://github.com/Leaflet/Leaflet.heat"
        ...
        <li>
            Cartes choroplètes: <a
                href="https://www.datavis.fr/d3js/map-population"
                ><code>d3.js</code></a
            >,
