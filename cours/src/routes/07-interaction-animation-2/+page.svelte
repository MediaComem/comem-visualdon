...
<Slide>
  <div class="row center">
    <div class="col-50">
      ...
      <h5>Événements</h5>
      <code class="small"
        >d3.brush().<span class="red">on(typenames, listener)</span></code
      >
      <ul>
        <li class="small">
          <code class="small"><span class="red">typenames</span></code>: Les
          types d'événements à écouter, par exemple,
          <code class="red">'brush'</code>, <code class="red">'start'</code>,
          <code class="red">'end'</code>. Retourne:
          <code class="red">event.selection</code> qui correspond à l'étendue du
          brush [[x0,y0],[x1,y1]]
        </li>
        <li class="small">
...
<Slide>
  ...
  <p class="small">
    éxécute une fonction de manière répétée avec une intervalle fixée. Retourne
    un identifiant unique (<code>intervalId</code>).
  </p>
