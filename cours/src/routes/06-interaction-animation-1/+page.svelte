...
<Slide>
  ...
  <div class="row">
    <div class="col-50">
      <div class="center">
        <img src={TransitionSyntax} alt="transition-syntax" height="250" />
      </div>
...
<Slide>
  ...
  <div class="center">
    <code class="small"
      >transition().<span class="red">duration(dureeTransition)</span></code
    >
  </div>
...
<Slide>
  ...
  <div class="row">
    <div class="col-50">
      ...
      >
      <div class="center">
        <img src={ScaleExtent} alt="scale-extent" width="60%" class="center" />
      </div>
    </div>
...
<Slide>
  ...
  <div class="row">
    <div class="col-50">
      ...
      <small
        ><code class="small"
          >(zoom.<span class="red">scaleBy, facteur_échelle</span>)</code
        >
