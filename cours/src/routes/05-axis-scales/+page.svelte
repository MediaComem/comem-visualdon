...
<Slide>
    <div class="row center">
        <div class="col-50">
            ...
            <div class="center">
                <img
                    src={domainRangeSyntax}
                    alt="scale-syntax-code"
                    width="60%"
                />
            </div>
            <ul>
                <li class="small">
                    <b><code class="red">typeEchelle</code></b>: La fonction
                    qui détermine quel type d'échelle sera utilisé, tels que
                    linéaire, quadratique, exponontielle etc.
                </li>
                <li class="small">
                    <b
                        ><code class="red">domain</code><code
                            >([minData, maxData])</code
                        ></b
                ...
                <li class="small">
                    <b
                        ><code class="red">range</code><code
                            >([0, svgWidth])</code
                        ></b
                    >: Définit l'intervalle de sortie, la plage de valeurs
                    souhaitée, avec
...
<Slide>
    ...
    <div class="row">
        <div class="col-50">
            ...
            <ul>
                <li class="small">
                    <span class="red">axisBottom</span>: Fonction de D3 qui
                    crée un axe horizontal en bas.
                </li>
                <li class="small">
                    <span class="red">echelle</span>: L'échelle à associer à
                    l'axe.
                </li>
            </ul>
        </div>
        ...
        <div class="col-50">
            ...
            <ul>
                <li class="small">
                    <span class="red">selecteur</span>: Le sélecteur
                    représentant l'élément auquel l'axe sera ajouté.
                </li>
                <li class="small">
                    <span class="red">g</span>: L'élément "g" (groupe) SVG qui
                    servira de conteneur pour l'axe.
                </li>
                <li class="small">
                    <span class="red">call</span>: Une méthode D3 qui invoque
                    une fonction (dans ce cas, l'axe) sur l'élément
                    sélectionné.
                </li>
                <li class="small">
                    <span class="red">axe</span>: L'axe créé avec
                    <code class="small"
                        >const axe = <span class="red">axisBottom</span
                        >(echelle)</code
                    >, prêt à être dessiné.
                </li>
            </ul>
