...
<Title title="6. Intéraction et animation 2"></Title>

<Slide class="fragment">
  <h2>Cours précédent</h2>
  <p class="fragment">
    <span class="red">Animation</span>
    <code>transitions, data().join(enter, update, exit)</code>
  </p>
  <p class="fragment">
    <span class="red">Interaction</span> <code>.zoom()</code>
  </p>
</Slide>

<Slide>
  <a href="https://github.com/d3/d3-brush"
    ><h2><code class="red">d3-brush</code></h2></a
  >
  <p>
  ...
  <img src="assets/brush.gif" alt="brush" class="center" />
</Slide>

<Slide>
  <h2>Brush</h2>
  <code><span class="red">brush()</span></code>
  <div class="row">
    <div class="col-40">
      <img src="assets/brush-syntaxe.svg" alt="" height="300" />
    </div>
    <div class="col-60">
      <br />
      <ul>
...
<Slide>
  <h2>Brush</h2>
  <a
    href="https://codepen.io/romanoe/pen/BaOVQER"
    target="_blank"
...
<Slide>
  ...
  <br />
  <h5>
    <code><span class="red">clearInterval</span>(<em>intervalId</em>)</code>
  </h5>
  <small><p>arrête l'intervalle</p></small><br />

  <small
    ><a href="https://developer.mozilla.org/en-US/docs/Web/API/setInterval"
      ><p><code class="red"> ↳ Doc MDN : setInterval()</code></p></a
    ></small
  >
</Slide>
...
<Slide>
  <h2>Animation</h2>
  <a
    href="https://codepen.io/romanoe/pen/rNZKjvB"
    target="_blank"
    rel="noopener noreferrer"><code>Codepen</code></a
  >
</Slide>
...
<Slide>
  <h2>Projet</h2>
  <ul>
    <li>Wireframe (ce soir !)</li>
    <li>Structurer et charger les données</li>
